...
<div id="manage" class="tabcontent">
  ...
  <table id="manage_account" class="datatable-element table dataTables_info resident table-striped jambo_table bulk_action text-center border" >
            ...
            <tbody>
                ...
                <?php $__currentLoopData = $account; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $account): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>


               <tr class="even pointer">
                <td class=" " hidden><?php echo e($account->account_id); ?></td>
                  <td class=" pt-1 pb-1">
                 ...
                 <a href="#" class="btn btn-danger btn-xs pr-4 pl-4"><i class="fa fa-times fa-lg"></i>  </a>
                  ...
                  <td class=" "><?php echo e($account->last_name); ?></td>
                  <td class=" "><?php echo e($account->first_name); ?> </td>
                  <td class=" "><?php echo e($account->username); ?></td>
                  <td class=" "><?php echo e($account->username); ?></td>

                  <td class=" "><?php echo e($account->password); ?> </td>
               </tr>
  ...
  <table id="resident" class="dataTables_info table datatable-element  resident table-striped jambo_table bulk_action text-center border">
            ...
            <tbody>
                ...
                <?php if(count($sessions) > 0): ?>
                    <?php $__currentLoopData = $sessions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sessions): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>



               <tr class="even pointer">
                  <td class=" " hidden><?php echo e($sessions->session_id); ?></td>
                  <td class=" " hidden><?php echo e($sessions->user_id); ?></td>
                  <td class=" "><?php echo e($sessions->username); ?> </td>
                  <td class=" "><?php echo e($sessions->created_at); ?></td>
               </tr>
                     <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
               <?php endif; ?>
...
<?php echo $__env->make('layouts.apps', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/Barangay/resources/views/pages/setting/account.blade.php ENDPATH**/ ?>