               ...
               <div class="row">
                  ...
                  <div class="column-center text-center" >
                     <p id="heading"  style='font-size:19px;font-family: "Times New Roman, Times, serif";'> REPUBLIC OF THE PHILIPPINES<br>
                        ...
                        <b ><u>  {{ $layout->barangay ?? 'barangay not set'  }}<br></u></b>
                     </p>
                     <div id="punong" style='font-size:22px;font-family: "Times New Roman, Times, serif";padding:0px'><b>{{ $layout->office ?? 'office not set'  }}</b>
                     </div>
