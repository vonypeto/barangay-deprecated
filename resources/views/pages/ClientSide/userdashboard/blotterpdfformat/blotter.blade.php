...
<body class="login-page" style="background: white">
    ...
    <div class="row">
      ...
      <div class="column-right text-right" >
        <img  style="width: 120PX" src="{{  url( $certificate_layout[0]->logo_1 ?? 'Logo not set')  }}" alt="logo">
      </div>
      ...
      <div class="column-left" >
        <img  style="width: 120PX"  src="{{  url( $certificate_layout[0]->logo_2 ?? 'Logo not set')  }}"  alt="logo">
      </div>
